...
<body>
    <div class="container">
        <a class="back-link" href="/mvc_project/public/index.php">⬅ Nazad na listu proizvoda</a>

        <h2 class="form-title">Izmeni proizvod</h2>

        <form class="product-form" action="/mvc_project/public/index.php?action=update" method="POST">
